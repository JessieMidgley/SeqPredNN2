...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(out_dir / "OS_parameters.pth"))
    ...
    torch.save(model.state_dict(), out_dir / "TPT-1-OS_parameters.pth")
    print("Saved PyTorch Model State to TPT-1-OS_parameters.pth")
